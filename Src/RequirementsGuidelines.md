...
# Characteristics of set of requirements statements:
| Criteria           | Description |
|-------------------|-------------|
| Complete         | The requirement set stands alone such that it sufficiently describes the necessary capabilities, characteristics, constraints, and/or quality factors to meet the entity needs without needing other information. |
...
| Feasible         | The requirement set can be realized within entity constraints (e.g., cost, schedule, technical, legal, regulatory) with acceptable risk. |
...
| R9    | Open-Ended Clauses  | Avoid open-ended, non-specific clauses such as “including but not limited to”, “etc.” and “and so on.” |


# Rules for Writing Good Requirements
| Rule  | Title                    | Description |
|-------|--------------------------|-------------|
| R10   | Superfluous Infinitives  | Avoid the use of superfluous infinitives such as “to be designed to”, “to be able to”, “to be capable of”, “to enable”, “to allow”. |
| R17   | Use of Oblique Symbol    | Avoid the use of the oblique ("/") symbol except in units, i.e., Km/hr, or fractions. |
| R20   | Purpose Phrases         | Avoid phrases that indicate the “purpose of“, “intent of”, or “reason for” the need statement or requirement statement. |
| R26   | Absolutes               | Avoid using unachievable absolutes such as 100% reliability, 100% availability, all, every, always, never, etc. |
| R32   | Universal Qualification | Use “each” instead of “all”, “any”, or “both” when universal quantification is intended. |
| R35   | Temporal Dependencies   | Define temporal dependencies explicitly instead of using indefinite temporal keywords such as “eventually”, “until”, “before”, “after”, “as”, “once”, “earliest”, “latest”, “instantaneous”, “simultaneous”, and “at last”. |


# Rules for writing well-formed requirement statements
| Rule  | Title                              | Description |
|-------|------------------------------------|-------------|
| R5    | Definite Articles                 | Use the definite article “the” rather than the indefinite articles “a” or “an”. |
| R15   | Logical Expressions               | Use a defined convention to express logical expressions such as “[X AND Y]”, “[X OR Y]”, “[X XOR Y]”, “NOT [X OR Y]”. |
| R21   | Parentheses                       | Avoid parentheses and brackets containing subordinate text. |
| R22   | Enumeration                       | Enumerate sets explicitly instead of using a group noun to name the set. |
| R23   | Supporting Diagram, Model, or ICD | When a need or requirement is related to complex behavior, refer to a supporting diagram, model, or ICD. |
| R29   | Classification                    | Classify needs and requirements according to the aspects of the problem or system it addresses. |
| R30   | Unique Expression                 | Express each need and requirement once and only once. |
| R31   | Solution Free                     | Avoid stating implementation in a need statement or requirement statement unless there is rationale for constraining the design. |
